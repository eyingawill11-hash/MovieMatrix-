const translations = {
    en: { 
        ...
        // New Additions
        ud_sum: "Eight friends are trapped on a remote mountain retreat with a killer.",
        s7_sum: "The legendary horror franchise continues with a new chapter of terror.",
        as_sum: "A CIA agent drags an old friend into a world of international espionage.",
        jd_sum: "Coroners experience supernatural phenomena while examining an unknown body.",
        it_sum: "Seven helpless children are face-to-face with a shape-shifting clown.",
    ...
    fr: { 
        ...
        // New Additions
        ud_sum: "Huit amis sont piégés dans un chalet de montagne isolé avec un tueur.",
        s7_sum: "La légendaire franchise d'horreur continue avec un nouveau chapitre.",
        as_sum: "Un agent de la CIA entraîne un vieil ami dans une affaire d'espionnage.",
        jd_sum: "Des médecins légistes vivent des phénomènes surnaturels lors d'une autopsie.",
        it_sum: "Sept enfants font face à un clown métamorphe terrifiant.",
...
const myMovies = [
    ...
    // New Movie Additions
    { title: "Until Dawn", year: "2025", genre: "Horror", country: "USA", budget: "$30M", img: "images/until_dawn.jpg", url: "movies/until_dawn.mp4", likes: 0, dislikes: 0, userChoice: null, sKey: "ud_sum" },
    { title: "Scream 7", year: "2026", genre: "Horror", country: "USA", budget: "$40M", img: "images/scream_7.jpg", url: "movies/scream7.mp4", likes: 0, dislikes: 0, userChoice: null, sKey: "s7_sum" },
    { title: "Agents un peu trop secret", year: "2016", genre: "Action", country: "USA", budget: "$50M", img: "images/agents.jpg", url: "movies/agents.mp4", likes: 0, dislikes: 0, userChoice: null, sKey: "as_sum" },
    { title: "The Jane Doe Identity", year: "2016", genre: "Horror", country: "UK", budget: "$6M", img: "images/jane_doe.jpg", url: "movies/janedoe.mp4", likes: 0, dislikes: 0, userChoice: null, sKey: "jd_sum" },
    { title: "IT", year: "2017", genre: "Horror", country: "USA", budget: "$35M", img: "images/it_2017.jpg", url: "movies/it.mp4", likes: 0, dislikes: 0, userChoice: null, sKey: "it_sum" }
];
